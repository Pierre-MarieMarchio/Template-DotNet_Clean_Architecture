...
namespace AppTemplate.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260908075915_AddStoredFileTags")]
    partial class AddStoredFileTags
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppTemplate.Infrastructure.Persistence.Features.Identity.Models.RefreshToken", b =>
                {
                    b.HasOne("AppTemplate.Infrastructure.Persistence.Features.Identity.Models.AppUser", "User")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("AppTemplate.Infrastructure.Persistence.Features.Identity.Models.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
