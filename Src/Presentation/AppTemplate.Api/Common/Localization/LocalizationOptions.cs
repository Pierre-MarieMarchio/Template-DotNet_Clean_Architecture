...
/// contract with whoever deploys it. <c>AppTemplate.Worker</c> binds the same section with its own
/// twin of this class, so the two hosts cannot disagree about what an unattributed mail reads like.
/// </para>
/// </summary>
public sealed class LocalizationOptions
{
    ...
    /// <summary>
    /// A culture name — <c>en</c>, <c>fr</c>, <c>fr-CA</c>. Used when a request carries no usable
    /// <c>Accept-Language</c>, and for every mail a background pass sends.
    /// </summary>
