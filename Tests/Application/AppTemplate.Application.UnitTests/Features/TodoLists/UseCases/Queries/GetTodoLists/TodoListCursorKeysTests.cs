...
public sealed class TodoListCursorKeysTests
{
    ...
    public void Validate_AValidCreatedAtKey_Succeeds()
    {
        ...
        TodoListCursorKeys.Validate(cursor).IsSuccess.ShouldBeTrue();
    }
    ...
    public void Validate_ATamperedCreatedAtKey_IsRejectedAsCursorInvalid()
    {
        ...
        var result = TodoListCursorKeys.Validate(cursor);
    ...
    public void Validate_Rejects_ANullCursor() =>
        Should.Throw<ArgumentNullException>(() => TodoListCursorKeys.Validate(null!));
}
