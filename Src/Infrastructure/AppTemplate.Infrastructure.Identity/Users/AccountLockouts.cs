...
{
    public async Task<LockoutChangeOutcome> LockAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        ...
        if (user is null)
        {
            return LockoutChangeOutcome.NoSuchAccount;
        }
        ...
        {
            return LockoutChangeOutcome.Rejected;
        }
        ...
        return LockoutChangeOutcome.Applied;
    }

    public async Task<LockoutChangeOutcome> UnlockAsync(Guid userId, CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
        ...
        return wasNeverLockable ? LockoutChangeOutcome.Applied : LockoutChangeOutcome.Rejected;
    }
}
