...
{
    /// <summary>
    /// Name to pass to <c>[RequestTimeout(LifecyclePolicies.LongRequestTimeoutPolicy)]</c> on a
    ...
    public static IServiceCollection AddApiLifecycle(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        // Same idiom as RequestLimitsPolicies configuring KestrelServerOptions from its own options.
