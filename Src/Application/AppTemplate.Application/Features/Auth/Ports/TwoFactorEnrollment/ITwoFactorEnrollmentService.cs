...
/// <para>
/// Deliberately not the login-time challenge — see <c>ITwoFactorChallengeService</c>. That capability is
...
public interface ITwoFactorEnrollmentService
{
    ...
    /// password is required for the reason <c>IUserAccountsService.ChangePasswordAsync</c> gives: a stolen
