...
{
    public async Task<TwoFactorAdministrativeDisableOutcome> DisableAsync(
        Guid userId,
        CancellationToken cancellationToken = default)
    {
        ...
        if (user is null)
        {
            return TwoFactorAdministrativeDisableOutcome.NoSuchAccount;
        }
        ...
        {
            return TwoFactorAdministrativeDisableOutcome.Rejected;
        }
        ...
        return TwoFactorAdministrativeDisableOutcome.Disabled;
    }
}
