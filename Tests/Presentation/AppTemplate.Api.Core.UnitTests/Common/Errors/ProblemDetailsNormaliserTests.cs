...
namespace AppTemplate.Api.Core.UnitTests.Common.Errors;

public sealed class ProblemDetailsNormaliserTests
{
    [Fact]
    ...
    public void Normalise_DerivesCodeFromStatus_WhenNoneIsPresent()
    {
        ...
        problem.Extensions["code"].ShouldBe(ProblemDetailsNormaliser.CodeFor(StatusCodes.Status404NotFound));
    }
