...
/// <para>
/// <b>Why it is named <c>EfUnitOfWork</c> and not <c>UnitOfWork</c>.</b> The prefix says which
/// technology implements the port. <c>IUnitOfWork</c> is an Application-layer contract with no
/// technology in it, and a save is the one place where the choice of Entity Framework is visible —
/// so the adapter carries the technology in its name rather than reading as a second, nameless
/// unit of work. It costs nothing and it tells the reader which one they have.
/// </para>
/// <para>
