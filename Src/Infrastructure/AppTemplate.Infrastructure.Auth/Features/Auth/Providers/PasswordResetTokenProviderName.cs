namespace AppTemplate.Infrastructure.Auth.Features.Auth.Providers;
...
/// lifespan (see <see cref="AppTemplate.Infrastructure.Auth.Common.Options.IdentityTokenOptions"/>) instead of its
/// own, shorter one.
/// </para>
/// </summary>
