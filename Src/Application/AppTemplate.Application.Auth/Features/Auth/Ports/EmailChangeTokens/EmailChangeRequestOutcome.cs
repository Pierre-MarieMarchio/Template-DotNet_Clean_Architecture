...
{
    /// <summary>The current password did not match: nothing was minted, nothing is to be sent.</summary>
    ...
    /// <summary>The password matched and there is a token to mail to the new address.</summary>
