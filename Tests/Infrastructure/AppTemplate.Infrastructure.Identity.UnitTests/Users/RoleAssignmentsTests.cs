...
public sealed class RoleAssignmentsTests
{
    ...
    public async Task AddingARoleToAnUnknownAccount_IsReportedAsNoSuchAccount()
    {
        ...
        change.Outcome.ShouldBe(RoleAssignmentChangeOutcome.NoSuchAccount);
    }
    ...
    public async Task AddingAnUnseededRole_IsRejectedRatherThanThrowing()
    {
        ...
        change.Outcome.ShouldBe(RoleAssignmentChangeOutcome.Rejected);
    ...
    public async Task AddingASeededRole_Succeeds()
    {
        ...
        change.Outcome.ShouldBe(RoleAssignmentChangeOutcome.Applied);
    }
