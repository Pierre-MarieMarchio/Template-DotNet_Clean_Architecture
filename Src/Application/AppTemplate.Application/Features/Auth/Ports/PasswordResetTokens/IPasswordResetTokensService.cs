...
/// <para>
/// Issued whatever the address's confirmation status: unlike <see cref="IEmailConfirmationTokensService"/>,
...
/// <see cref="IEmailConfirmationTokensService"/>.
/// </para>
/// <para>
...
public interface IPasswordResetTokensService
{
    ...
    /// <see cref="IEmailConfirmationTokensService.RedeemAsync"/>.
    /// </summary>
