...
/// <remarks>
/// <para>
/// The grant store is composed exactly as the identity module composes it — through
/// <c>AddPersistenceModule</c> and resolved as <c>IRefreshTokenStore</c> — so what the tests exercise
...
/// hand-written store would answer whatever it was written to answer.
/// </para>
/// </remarks>
public sealed class GrantStoreFixture : IAsyncLifetime
{
    ...
    public IServiceProvider Services => _services
        ?? throw new InvalidOperationException($"{nameof(GrantStoreFixture)} has not been initialised.");
    ...
    /// assembly, and a test that could name it could also write one without going through the store.
    /// </remarks>
