...
public sealed class UserAccountsTests : IDisposable
{
    ...
    public async Task ALockedOutAccount_StillCostsOnePasswordVerificationFromTheConfiguredHasher()
    {
        ...
        check.Outcome.ShouldBe(CredentialCheckOutcome.LockedOut);
        _passwordHasher.Verifications.ShouldBe(
            1,
    ...
    public async Task AnUnconfirmedEmailAccount_StillCostsOnePasswordVerificationFromTheConfiguredHasher()
    {
        ...
        check.Outcome.ShouldBe(CredentialCheckOutcome.EmailNotConfirmed);
    ...
    /// <see cref="CredentialCheckOutcome.LockedOut"/> and <see cref="CredentialCheckOutcome.EmailNotConfirmed"/>.
    /// </summary>
    [Fact]
    public async Task AnIncorrectPassword_DoesNotTriggerTheExtraDerivation()
    {
        ...
        check.Outcome.ShouldBe(CredentialCheckOutcome.IncorrectPassword);
        _passwordHasher.Verifications.ShouldBe(
            0,
