...
/// </summary>
public sealed class TodoListResponseMappingTests
{
    [Fact]
    public void ToResponse_Item_CopiesEveryField()
    {
        ...
        var response = TodoListResponseMapping.ToResponse(item);
    ...
    public void ToResponse_List_CopiesEveryField()
    {
        ...
        var response = TodoListResponseMapping.ToResponse(list);
    ...
    public void ToResponse_Items_CopiesEveryFieldOfEveryItem()
    {
        ...
        var response = TodoListResponseMapping.ToResponse((IReadOnlyList<TodoItemDto>)[item]);
    ...
    public void ToResponse_Items_KeepsTheItemsInTheOrderReceived()
    {
        ...
        var response = TodoListResponseMapping.ToResponse(items);
    ...
    {
        var response = TodoListResponseMapping.ToResponse((IReadOnlyList<TodoItemDto>)[]);
    ...
    public void ToResponse_Summary_CopiesEveryField()
    {
        ...
        var response = TodoListResponseMapping.ToResponse(summary);
    ...
    public void ToPageResponse_CarriesEveryMetadataMember_OfAnOffsetPage()
    {
        ...
        var response = TodoListResponseMapping.ToPageResponse(page).Value;
    ...
    public void ToListResponse_KeepsTheVersion()
    {
        ...
        var result = TodoListResponseMapping.ToListResponse(Result.Success(new Versioned<TodoListDetailDto>(list, 12)));
    ...
    public void ToItemResponse_KeepsTheVersion()
    {
        ...
        var result = TodoListResponseMapping.ToItemResponse(Result.Success(new Versioned<TodoItemDto>(item, 4)));
    ...
    public void ToItemsResponse_KeepsTheVersion()
    {
        ...
        var result = TodoListResponseMapping.ToItemsResponse(Result.Success(new Versioned<IReadOnlyList<TodoItemDto>>(items, 9)));
    ...
    {
        var result = TodoListResponseMapping.ToPageResponse(Result.Failure<PagedResult<TodoListSummaryDto>>(_someError));
    ...
    {
        var result = TodoListResponseMapping.ToListResponse(Result.Failure<Versioned<TodoListDetailDto>>(_someError));
    ...
    {
        var result = TodoListResponseMapping.ToItemResponse(Result.Failure<Versioned<TodoItemDto>>(_someError));
    ...
    {
        var result = TodoListResponseMapping.ToItemsResponse(
