...
/// <summary>
/// The adapter for <see cref="IReminderTargetQueries"/>: one query for a whole batch of item ids, read
...
/// the type, only <see cref="IReminderTargetQueries"/>.
/// </para>
/// </summary>
internal sealed class ReminderTargetQueries(AppDbContext context) : IReminderTargetQueries
{
