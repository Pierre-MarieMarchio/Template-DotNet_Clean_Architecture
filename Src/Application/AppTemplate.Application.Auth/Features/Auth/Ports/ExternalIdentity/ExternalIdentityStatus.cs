...
/// <see cref="AppTemplate.Application.Auth.Features.Auth.Ports.UserAccounts.CredentialCheckStatus"/>.
/// </para>
/// </summary>
public enum ExternalIdentityStatus
{
    /// <summary>The token is authentic and what it says can be acted on.</summary>
    Verified,
