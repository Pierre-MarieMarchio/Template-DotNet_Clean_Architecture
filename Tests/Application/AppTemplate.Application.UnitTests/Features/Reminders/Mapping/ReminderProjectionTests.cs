...
public sealed class ReminderProjectionTests
{
    ...
    public void ToDto_MapsEveryField()
    {
        ...
        var dto = ReminderProjection.ToDto(reminder);
    ...
    public void ToVersioned_CarriesTheAggregatesOwnVersion()
    {
        ...
        var projected = ReminderProjection.ToVersioned(reminder);
    ...
    public void ToDto_Rejects_ANullReminder() =>
        Should.Throw<ArgumentNullException>(() => ReminderProjection.ToDto(null!));
}
