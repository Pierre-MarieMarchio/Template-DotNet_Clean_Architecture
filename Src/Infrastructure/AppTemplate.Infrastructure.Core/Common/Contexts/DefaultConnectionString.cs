...
namespace AppTemplate.Infrastructure.Core.Common.Contexts;

/// <summary>
/// The one connection string this system has. There is one PostgreSQL database, and every context
/// reaches it through this name: the halves of the system separate themselves by schema and by
/// migrations history, never by connection. A second name for the same database would be a second
/// thing to configure, and the two could disagree without anything noticing until runtime.
/// </summary>
