...
namespace AppTemplate.Api.Common.Startup;
...
/// </para>
/// </remarks>
internal static class DevelopmentStartup
{
    internal static async Task MigrateAndSeedForDevelopmentAsync(this WebApplication app)
    {
        ...
        var logger = services.GetRequiredService<ILoggerFactory>().CreateLogger(typeof(DevelopmentStartup));
