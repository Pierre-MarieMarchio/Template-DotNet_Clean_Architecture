...
/// </para>
/// <para>
/// A <em>store</em> rather than a repository, and that word is the whole distinction. A repository
...
/// owns the rows. See <c>docs/adr/0024-repository-in-domain-query-ports-in-application.md</c>.
/// </para>
/// <para>
