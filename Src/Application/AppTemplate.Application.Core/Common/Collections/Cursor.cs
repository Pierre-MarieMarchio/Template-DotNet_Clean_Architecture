...
public sealed record Cursor
{
    ...
    /// <summary>
    /// The direction this cursor was minted under. A request resuming it under the opposite one is
    /// refused rather than reinterpreted, because either reading skips or repeats rows.
    /// </summary>
