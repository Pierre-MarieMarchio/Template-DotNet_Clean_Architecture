...
/// </summary>
public sealed class ReminderResponseMappingTests
{
    [Fact]
    public void ToResponse_Reminder_CopiesEveryField()
    {
        ...
        var response = ReminderResponseMapping.ToResponse(reminder);
    ...
    public void ToResponse_Reminders_KeepsTheReceivedOrder()
    {
        ...
        var response = ReminderResponseMapping.ToResponse(reminders);
    ...
    {
        var response = ReminderResponseMapping.ToResponse((IReadOnlyList<ReminderDto>)[]);
    ...
    public void ToReminderResponse_KeepsTheVersion()
    {
        ...
        var result = ReminderResponseMapping.ToReminderResponse(Result.Success(new Versioned<ReminderDto>(reminder, 7)));
    ...
    {
        var result = ReminderResponseMapping.ToReminderResponse(Result.Failure<Versioned<ReminderDto>>(_someError));
    ...
    public void ToRemindersResponse_CarriesEveryReminder()
    {
        ...
        var result = ReminderResponseMapping.ToRemindersResponse(Result.Success(reminders));
    ...
    {
        var result = ReminderResponseMapping.ToRemindersResponse(Result.Failure<IReadOnlyList<ReminderDto>>(_someError));
