...
/// <para>
/// Unlike <c>IEmailConfirmationTokensService</c> and <c>IPasswordResetTokensService</c>, both halves are keyed by
...
/// <c>IEmailConfirmationTokensService</c>.
/// </para>
/// <para>
...
/// </para>
/// </summary>
public interface IEmailChangeTokensService
{
    /// <summary>
    ...
    /// stamp as part of this call — see <c>IUserAccountsService.ChangePasswordAsync</c> for what that
